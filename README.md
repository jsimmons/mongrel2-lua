...
* [ZeroMQ-lua](http://www.zeromq.org/bindings:lua) <s>but for zmq 2.0.7 you'll need [my fork](http://github.com/jsimmons/lua-zmq) as some constants have changed names.</s>
